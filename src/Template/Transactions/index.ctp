...
<div id="TransactionsIndex">
    ...
    <div class="transactions index large-9 medium-8 columns content">
        <table id="TransactionsTable" cellpadding="0" cellspacing="0">
            <caption><h4><?= __('Transactions for Book: '.$book['title']) ?></h4></caption>
            <thead>
                <tr>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="actions">
                        ...
                        <?= $this->Html->link(__('Edit'), ['book_id'=>$book['id'],'action'=>'editform', 'id'=>$transaction->id, '_method'=>'GET'],['name'=>'TransactionEditform']) ?>
