...
class AccountsControllerTest extends DMIntegrationTestCase {
    ...
    public function testGET_view() {
        ...
        // 3. Count the A tags.
        $unknownATagCnt=$nodes=$xpath->query("//div[@id='AccountsView']//a")->length;
        ...
        $this->getTheOnlyOne($xpath,"//a[@id='AccountDistributions']");
        $unknownATagCnt--;
        ...
        // 5. Ensure that there is a suitably named table to display the results.
        $table_nodes=$this->getTheOnlyOne($xpath,"//div[@id='AccountsView']//table[@id='AccountViewTable']");
