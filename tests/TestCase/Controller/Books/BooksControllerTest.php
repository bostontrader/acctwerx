...
class BooksControllerTest extends DMIntegrationTestCase {
    ...
    public function testGET_add() {
        ...
        $content_node=$this->getTheOnlyOne($xpath,"//div[@id='BooksAdd']");
        ...
        $form_node=$this->getTheOnlyOne($xpath,"//form[@id='BookAddForm']",$content_node);
    ...
    public function testGET_edit() {
        ...
        // 2. Isolate the content produced by this controller method (excluding the layout.)
        $content_node=$this->getTheOnlyOne($xpath,"//div[@id='BooksEdit']");
        ...
        // 4. Ensure that the expected form exists
        $form_node=$this->getTheOnlyOne($xpath,"//form[@id='BookEditForm']",$content_node);
    ...
    public function testGET_index() {
        ...
        $this->getTheOnlyOne($xpath,"//a[@id='BookAdd']",$content_node);
        $unknownATagCnt--;
