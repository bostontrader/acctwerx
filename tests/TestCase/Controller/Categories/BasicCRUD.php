...
class CategoriesControllerTest extends DMIntegrationTestCase {
    ...
    public function testGET_newform() {
        ...
        $content_node=$this->getTheOnlyOne($xpath,"//div[@id='CategoriesNewform']");
        ...
        $form_node=$this->getTheOnlyOne($xpath,"//form[@id='CategoryNewformForm']",$content_node);
    ...
    public function testGET_editform() {
        ...
        $this->get("/categories/$category_id/editform");
        $this->assertResponseCode(200);
        $this->assertNoRedirect();
        $dom = new \DomDocument();
        $dom->loadHTML($this->_response->body());
        ...
        // 2. Isolate the content produced by this controller method (excluding the layout.)
        $content_node=$this->getTheOnlyOne($xpath,"//div[@id='CategoriesEditform']");
        ...
        // 4. Ensure that the expected form exists
        $form_node=$this->getTheOnlyOne($xpath,"//form[@id='CategoryEditformForm']",$content_node);
    ...
    public function testGET_index() {
        ...
        $this->getTheOnlyOne($xpath,"//a[@id='CategoryNewform']",$content_node);
        $unknownATagCnt--;
        ...
        foreach ($iterator as $values) {
            ...
            $this->getTheOnlyOne($xpath,"a[@name='CategoryEditform']",$column_nodes->item(2));
            $unknownATagCnt--;
